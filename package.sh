...
rsync -av --exclude='.git' --exclude='assets*' --exclude='plan*.md' --exclude='mod-description.md' --exclude='.DS_Store' --exclude='AGENTS.md' --exclude='CLAUDE.md' --exclude='.gitignore' --exclude='package.sh' --exclude='*.zip' --exclude='.claude*' --exclude='tests*' --exclude='validate*' --exclude='archive' --exclude='.luacheckrc' ./ "$FULL_PACKAGE_DIR/"
